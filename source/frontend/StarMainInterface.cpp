  ...
  , m_containerInteractor(make_shared<ContainerInteractor>())
{
  ...
  m_achievementsPane = make_shared<ScriptPane>(m_client, "/interface/opensb/achievements/achievements.config");
  m_paneManager.registerPane(MainInterfacePanes::Achievements, PaneLayer::ModalWindow, m_achievementsPane);
